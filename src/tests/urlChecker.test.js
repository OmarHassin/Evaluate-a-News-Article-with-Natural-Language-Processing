...
describe('Test, the function "validURL()" for valid url' , () => {
    var url = "https://www.studentnewsdaily.com/daily-news-article/merry-christmas-and-happy-2020/";
    test('It should return true', async () => {
...
describe('Test "validURL()" for invalid url' , () => {
    ...
    var url = "htpshttps://www.studentnewsdaily.com/daily-news-article/merry-christmas-and-happy-2020/";
